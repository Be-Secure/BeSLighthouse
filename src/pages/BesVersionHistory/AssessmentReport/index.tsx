...
function GetAssessmentData(version, name, report, itemData, masterData) {
  ...
  if (report === "Criticality Score" && jsonDataLength !== 0) {
    ...
    if (jsonData.criticality_score.toFixed(2) >= 0.10 && jsonData.criticality_score.toFixed(2) < 0.40) {

      color_code = "#008000";

      risk_level = "Low risk";

    } else if (jsonData.criticality_score.toFixed(2) >= 0.40 && jsonData.criticality_score.toFixed(2) < 0.60) {

      color_code = "#FFC300";

      risk_level = "Medium risk";

    } else if (jsonData.criticality_score.toFixed(2) >= 0.60 && jsonData.criticality_score.toFixed(2) <= 1.00) {
