...
export const modelOfInterestData =
  jsonData.activeTool === 'github' ? `${jsonData[toolName].apiUrl}/${jsonData[toolName].namespace}/besecure-assets-store/deepseek/models/model-metadata.json` : `${jsonData[toolName].apiUrl}/model_of_interest`;
export const besecureMlAssessmentDataStore = jsonData.activeTool === 'github' ? `${jsonData[toolName].apiUrl}/${jsonData[toolName].namespace}/besecure-ml-assessment-datastore/deepseek/models` : `${jsonData[toolName].apiUrl}/model_assessment`;
