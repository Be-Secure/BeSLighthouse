...
export const besecureMlAssessmentDataStore = jsonData.activeTool === 'github' ? `${jsonData[toolName].apiUrl}/${jsonData[toolName].namespace}/besecure-ml-assessment-datastore/${jsonData[toolName].branch}/models` : `${jsonData[toolName].apiUrl}/model_assessment`;
